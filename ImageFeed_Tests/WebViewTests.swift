...
final class ImageFeed_Tests: XCTestCase {
    ...
    // MARK: - Тест необходимости скрытия прогресса: метод shouldHideProgress презентера работает корректно
    ...
    // MARK: - test: AuthHelper корректно распознаёт код из ссылки
